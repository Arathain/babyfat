...
public class OldRanchuBreedGoal extends Goal {
	...
	public OldRanchuBreedGoal(Ranchu animal, double speedIn) {
		this(animal, speedIn, animal.getClass());
	}

	public OldRanchuBreedGoal(Ranchu animal, double moveSpeed, Class<? extends Ranchu> mateClass) {
		this.animal = animal;
