...
public class BFCriteriaTriggers extends SimpleCriterionTrigger<BFCriteriaTriggers.TriggerInstance> {
    private final ResourceLocation ID;

    public BFCriteriaTriggers(String name) {
        ID = new ResourceLocation(BabyFat.MOD_ID, name);
    }
    ...
    protected TriggerInstance createInstance(JsonObject p_66248_, ContextAwarePredicate predicate, DeserializationContext p_66250_) {
        return new BFCriteriaTriggers.TriggerInstance(ID, predicate);
    }
